...
namespace projectCleanArch.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        public void CreateProduct_NegativeIdValue_DomainExceptionInvalidId()
        {
            ...
            action.Should().Throw<projectCleanArch.Domain.Validation.DomainExceptionValidation>()
        ...
        public void CreateProduct_WithNullImageName_NoDomainException()
        {
            ...
            action.Should().NotThrow<projectCleanArch.Domain.Validation.DomainExceptionValidation>();
        }
